...
```  
Jetzt ist Git bereit, als lokale Versionskontrolle zu dienen, und die Änderungen mit GitHub zu synchronisieren.  
**!ACHTUNG!**  
Da nur Name und Mailadresse angegeben werden, sollte jedem ersichtlich sein, dass prinzipiell alle Nutzer mit Zugriff auf deine Mailadresse in deinem Namen zu deinen Projekten Commits erstellen können!  
Dies lässt sich über die Nutzung von geheimen Pass-Keys verhindern, die jedoch absolut furchtbar im Setup sind, und auf die ich hier nicht weiter eingehen will.
