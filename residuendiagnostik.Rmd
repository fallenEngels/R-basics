...
plot_grid(
  ...
  dat %>% 
    ...
    labs(y = "", subtitle = "Stetige Varianzveränderung, Verletzung A1") + theme_minimal(),
  dat %>% 
    ...
    geom_path(aes(x = x, y = y), data.frame(x = c(0, 25, 50, 75, 100), y = c(-1.25, -2.1, -2.3, -2.1, -1.25)), 
              linetype = 2, colour = "blue") + 
    labs(y = "", subtitle = "Verschiedene Varianzdynamiken, Verletzung A1") + theme_minimal(),
  dat %>% 
  ...
  dat %>% 
    ...
    geom_path(aes(x = x, y = y), data.frame(x = c(0, 30, 30, 39, 39, 49, 49, 60, 60, 100), 
              ...
              linetype = 2, colour = "blue") +
    labs(y = "", subtitle = "Verschiedene Varianzen, Verletzung A1") + theme_minimal(),
  nrow = 2
)
```
